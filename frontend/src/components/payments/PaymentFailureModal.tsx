  ...
  return (
    <div className="pricing-modal-overlay">
      <div className="pricing-modal">
        <div className="payment-result-modal failure-modal">
          {/* Close button */}
          <button
          ...
          <div className="result-icon failure-icon">
            ...
            >
              <g clipPath="url(#clip0_215_7259_fail)">
                <path
                  className="failure-bar bar-1"
                  ...
                  fill="url(#paint0_linear_215_7259_fail)"
                />
                <path
                  className="failure-bar bar-2"
                  ...
                  fill="url(#paint1_linear_215_7259_fail)"
                />
                <path
                  className="failure-bar bar-3"
                  ...
                  fill="url(#paint2_linear_215_7259_fail)"
                />
                <path
                  className="failure-bar bar-4"
                  ...
                  fill="url(#paint3_linear_215_7259_fail)"
                />
                <path
                  className="failure-bar bar-5"
                  ...
                  fill="url(#paint4_linear_215_7259_fail)"
                />
                <path
                  className="failure-character"
                ...
                <path
                  ...
                  fill="url(#paint5_linear_215_7259_fail)"
                  fillOpacity="0.92"
                  stroke="#1C5DFF"
                  strokeWidth="1.584"
                  strokeLinejoin="round"
                />
                <circle
                  className="failure-check-circle"
                  cx="87"
                  cy="66"
                  r="42"
                  fill="#F44949"
                />
                <path
                  className="failure-xmark"
                  d="M75 54L99 78M99 54L75 78"
                  stroke="white"
                  strokeWidth="4"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  ...
                  strokeLinecap="round"
                />
                <g filter="url(#filter0_i_215_7259_fail)">
                  <path
                    className="failure-glasses"
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="url(#paint6_linear_215_7259_fail)"
                  />
                </g>
                <path
                  className="failure-glasses"
              ...
              <defs>
                <linearGradient
                  id="paint0_linear_215_7259_fail"
                  x1="43.957"
                  y1="13.0073"
                  x2="43.957"
                  y2="49.1753"
                ...
                <linearGradient
                  id="paint1_linear_215_7259_fail"
                  x1="131.605"
                  y1="46.0073"
                  x2="131.605"
                  y2="82.1753"
                ...
                <linearGradient
                  id="paint2_linear_215_7259_fail"
                  x1="11.75"
                  y1="77.4233"
                  x2="11.75"
                  y2="113.591"
                ...
                <linearGradient
                  id="paint3_linear_215_7259_fail"
                  x1="35.5117"
                  y1="100.655"
                  x2="35.5117"
                  y2="136.823"
                ...
                <linearGradient
                  id="paint4_linear_215_7259_fail"
                  x1="90.1562"
                  y1="9.83936"
                  x2="90.1562"
                  y2="46.0074"
                ...
                <linearGradient
                  id="paint5_linear_215_7259_fail"
                  x1="35.9976"
                  y1="67.9999"
                  x2="145.998"
                  y2="79.9999"
                ...
                <linearGradient
                  id="paint6_linear_215_7259_fail"
                  x1="3.76395"
                  y1="44.0456"
                  x2="6.10811"
                  y2="52.7942"
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_215_7259_fail"
                  />
                </filter>
                <clipPath id="clip0_215_7259_fail">
          ...
          <div className="result-content">
            ...
            <p className="result-message">
              One line to show the reason why failed
            </p>
          </div>
          ...
          <div className="result-buttons">
            ...
            <button className="result-button primary" onClick={handleTryAgain}>
              Try Again
            </button>
          </div>
          ...
          <div className="contact-support">
            <a href="mailto:iofferpublic@gmail.com" className="contact-link">
              Contact Support →
            </a>
          </div>
        </div>
